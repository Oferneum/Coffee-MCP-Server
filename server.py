...
def ask(query: str) -> str:
    ...
    try:
        ...
        parts.append(
            ...
            "Write your answer in this structure. Audience: home barista, new to espresso.\n\n"
            "### [PhysicsModel or root cause] — Why This Happens\n"
            "One sentence only. Name the scientific mechanism AND its cup consequence in plain English. "
            "Format: '[mechanism] means [what the barista tastes].' "
            "Example: 'When water moves too fast through the intergranular channels, it never "
            "slows down enough to dissolve the flavour locked inside each grain — you get colour "
            "without taste.'\n\n"
            "### What To Do\n"
            "2–3 bullets. Each bullet must contain THREE things:\n"
            "  1. **What to adjust** (specific — name the setting, not just the direction)\n"
            "  2. By how much or to what target (a number, a click count, a range)\n"
            "  3. What the barista will taste differently when it's right\n"
            "Example bullet: **Grind finer by 1–2 clicks**: reduces the gap between particles, "
            "forcing water to slow down and pull from inside each grain — the shot will gain "
            "viscosity and a longer, sweeter finish.\n\n"
            "Close the bullets with one original italicised metaphor — visceral and specific to "
            "espresso. Do NOT reuse the example metaphors from this prompt. Make it your own.\n\n"
            "End with: **You'll know it's working when** [one sensory success signal the barista "
            "can notice without equipment — texture, crema colour, aftertaste length, etc.].\n\n"
            "### Source\n"
            ...
            "Hard rules: ≤160 words total. No filler openers. No prose paragraphs. Markdown only. "
